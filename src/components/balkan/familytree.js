...
export let FamilyTree = function (e, t) {
  ...
  FamilyTree._validateConfig(this.config) && (this._vScroll = {}, this.config.ui || (this.ui = FamilyTree.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new FamilyTree.editUI, this.editUI.init(this), this.manager = new FamilyTree.manager(this.config, this._layoutConfigs), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new FamilyTree.searchUI, this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new FamilyTree.menuUI, this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.nodeCircleMenuUI ? this.nodeCircleMenuUI = this.config.nodeCircleMenuUI : this.nodeCircleMenuUI = new FamilyTree.circleMenuUI, this.nodeCircleMenuUI.init(this, this.config.nodeCircleMenu), this.config.nodeContextMenuUI ? this.nodeContextMenuUI = this.config.nodeContextMenuUI : this.nodeContextMenuUI = new FamilyTree.menuUI, this.nodeContextMenuUI.init(this, this.config.nodeContextMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new FamilyTree.toolbarUI, this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new FamilyTree.notifierUI, this.notifierUI.init(this), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new FamilyTree.menuUI, this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new FamilyTree.xScrollUI(this.element, this.config, (function () {
    ...
    i._draw(!0, FamilyTree.action.xScroll)
  }))), this.element.classList.add("bft-" + this.config.mode), this._gragStartedId = null, this._timeout = null, this._touch = null, this._initialized = !1, this._moveInterval = null, this._movePosition = null, this.response = null, this.nodes = null, this.isVisible = null, FamilyTree._intersectionObserver(this.element, (function (e) {
      ...
      if (!a.notifierUI.show(e.notif)) {
        ...
        if (FamilyTree.events.publish("render", [a, n]), o = n.content, e = n.res, o += a.ui.lonely(a.config), t !== FamilyTree.action.exporting) {
          ...
          if (y[0].length > 0) {
            ...
            FamilyTree.anim(y[0], y[1], y[2], a.config.anim.duration, a.config.anim.func, (function () {
              u || (r && r(), FamilyTree.events.publish("redraw", [a]), a._showAfterAnimation(), u = !0)
            }))
          }
          t === FamilyTree.action.centerNode ? FamilyTree.anim(a.getSvg(), {
            viewbox: s
          }, {
...
FamilyTree.prototype.ripple = function (e, t, i) {
  ...
  if (null != r) {
    ...
    if (null != a) {
      ...
      FamilyTree.events.publish("ripple", [this, T]), y.setAttribute("x", T.ripple.rect ? T.ripple.rect.x : 0), y.setAttribute("y", T.ripple.rect ? T.ripple.rect.y : 0), y.setAttribute("width", T.ripple.rect ? T.ripple.rect.width : r.w), y.setAttribute("height", T.ripple.rect ? T.ripple.rect.height : r.h), y.setAttribute("rx", T.ripple.radius), y.setAttribute("ry", T.ripple.radius), g.setAttribute("clip-path", "url(#" + b + ")"), g.setAttribute("cx", o), g.setAttribute("cy", l), g.setAttribute("r", 0), g.setAttribute("fill", T.ripple.color), g.setAttribute("class", "bft-ripple"), u.appendChild(y), f.appendChild(u), f.appendChild(g), a.appendChild(f), FamilyTree.anim(g, {
        r: 0,
        opacity: 1
      }, {
        r: h,
  ...
  if (!e || FamilyTree.isNEU(e.mid) && FamilyTree.isNEU(e.fid)) console.error("addSonNode invalid data");
    ...
    if (!1 !== this._fireUpdate_addUpdateRemove(a, i)) {
      ...
      FamilyTree.isNEU(a.addNodesData[0].pid) ? FamilyTree.isNEU(a.addNodesData[0].mid) ? FamilyTree.isNEU(a.addNodesData[0].fid) || (n = a.addNodesData[0].fid) : n = a.addNodesData[0].mid : n = a.addNodesData[0].pid, r._draw(!1, FamilyTree.action.insert, {
        ...
        r.ripple(a.addNodesData[0].id), t && t(), FamilyTree.events.publish("updated", [r, a])
...
FamilyTree.prototype.addChildAndPartnerNodes = function (e, t, i, r, a) {
  ...
  if (!t || FamilyTree.isNEU(t.mid) && FamilyTree.isNEU(t.fid)) console.error("addChildAndPartnerNodes invalid childData");
    ...
    var o = [],
      l = null;
    Array.isArray(i.pids) && (1 != i.pids.length && console.error("addChildAndPartnerNodes parentData.pids has to have one partner"), l = this.get(i.pids[0]), oldPartnerData = JSON.parse(JSON.stringify(l)), Array.isArray(l.pids) || (l.pids = []), l.pids.push(i.id), o.push(l));
    var s = {
      addNodesData: [t, i],
      updateNodesData: o,
      removeNodeId: null
    ...
    if (!1 !== this._fireUpdate_addUpdateRemove(s, a)) {
      ...
      l ? c = l.id : FamilyTree.isNEU(t.pid) ? FamilyTree.isNEU(t.mid) ? FamilyTree.isNEU(t.fid) || (c = t.fid) : c = t.mid : c = t.pid, n._draw(!1, FamilyTree.action.update, {
        ...
        n.ripple(t.id), n.ripple(i.id), r && r(), FamilyTree.events.publish("updated", [n, s])
  ...
  if (e && Array.isArray(e.pids) && 1 == e.pids.length) {
    ...
    if (!1 !== this._fireUpdate_addUpdateRemove(n, i)) {
      ...
      r._draw(!1, FamilyTree.action.insert, {
        ...
        r.ripple(n.addNodesData[0].id), t && t(), FamilyTree.events.publish("updated", [r, n])
  ...
  if (this.canRemove(e)) {
    ...
    if (Array.isArray(a.pids))
      for (var o = 0; o < a.pids.length; o++) {
        ...
        if (l) {
          var s = l.pids.indexOf(a.id); - 1 != s && (l.pids.splice(s, 1), n.push(l))
        }
      }
    if (Array.isArray(a.ftChildrenIds))
      for (o = 0; o < a.ftChildrenIds.length; o++) {
        var d = this.get(a.ftChildrenIds[o]);
        d && (d.mid == a.id ? (d.mid = void 0, n.push(d)) : d.fid == a.id && (d.fid = void 0, n.push(d)))
      }
    var c = {
      removeNodeId: e,
      updateNodesData: n,
    ...
    !1 !== this._fireUpdate_addUpdateRemove(c, i) && (this._draw(!1, FamilyTree.action.update, null, (function () {
...
}, void 0 === FamilyTree && (FamilyTree = {}), FamilyTree.anim = function (e, t, i, r, a, n, o) {
  var l, s = 10,
    d = 1,
    c = r / s + 1;
...
FamilyTree._intersects = function (e, t, i) {
  ...
  return "bottom" == a ? n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2 : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2), t.push([t[t.length - 1][0], n]), t.push([e.x - i.levelSeparation / 3, n]), o = t[t.length - 1][0], s = n, r.p = o, r.q = n, r.s = s, r
}, FamilyTree._addPointRight = function (e, t, i, r, a) {
  var n, o = t[t.length - 1][0];
  return "bottom" == a ? n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2 : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2), t.push([t[t.length - 1][0], n]), t.push([e.x + e.w + i.levelSeparation / 3, n]), o = t[t.length - 1][0], s = n, r.p = o, r.q = n, r.s = s, r
  ...
  this.obj.element.appendChild(a.element), FamilyTree.input.init(this.obj.element), i ? !t && a.focusId && FamilyTree.editUI.ficusElement(a.focusId) : this.interval = FamilyTree.anim(a.element, {
    right: -20,
    opacity: 0
  }, {
    right: 0,
  ...
  for (var n = this.obj.element.querySelectorAll("[bft-input-btn]"), o = 0; o < n.length; o++) {
  ...
  this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", (function (e) {
    ...
    a.focus(), a.nextElementSibling.addEventListener("click", (function (e) {
      ...
      if (FamilyTree.isNEU(a.value) || i) a.focus();
        ...
        a.parentNode.parentNode.parentNode.removeChild(a.parentNode.parentNode), t.parentNode.insertAdjacentHTML("beforebegin", n.html), t.style.display = "", FamilyTree.input.init(t.parentNode.previousSibling), document.getElementById(n.id).focus()
      }
    }))
...
FamilyTree.prototype.getMenuButton = function () {
  ...
  for (var s in a = l.menu) {
    var d = a[s].icon,
      c = a[s].text;
    void 0 === d && (d = FamilyTree.icon[s](24, 24, "#7A7A7A")), "function" == typeof c && (c = c()), "function" == typeof d && (d = d()), o += "<div " + FamilyTree.attr.item + '="' + s + '">' + d + "<span>&nbsp;&nbsp;" + c + "</span></div>"
  }
  if ("" != o) {
  ...
  if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
    ...
    if (FamilyTree.isNEU(h) || h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
      ...
      for (var y = 0, g = Object.keys(f.menu).length, b = 2 * a.nodeCircleMenuButton.radius + 4, T = 2 * Math.PI * b, v = T / g - (2 * a.nodeCircleMenuButton.radius + 2); v < 0;) b += 8, v = (T = 2 * Math.PI * b) / g - (2 * a.nodeCircleMenuButton.radius + 2);
      for (var F in (h = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id, e), h.setAttribute("transform", "matrix(1,0,0,1," + c + "," + m + ")"), n.appendChild(h), f.menu) {
        ...
        S.setAttribute("cx", 0), S.setAttribute("cy", 0), S.setAttribute("r", a.nodeCircleMenuButton.radius), S.setAttribute("fill", _), S.setAttribute("stroke-width", "1"), S.setAttribute("stroke", a.nodeCircleMenuButton.stroke), k.appendChild(S), k.appendChild(C), k.innerHTML += x, h.appendChild(k);
        ...
        var L = Math.cos(M) * b,
          E = Math.sin(M) * b;
        this._buttonsInterval.push(FamilyTree.anim(k, {
      ...
      this._linesInterval.push(FamilyTree.anim(p[0], {
        ...
        x2: 7,
        y2: 7
      }, 500, FamilyTree.anim.inOutSin)), this._linesInterval.push(FamilyTree.anim(p[1], {
        x1: -a.nodeCircleMenuButton.radius / 2,
        y1: 0,
        x2: a.nodeCircleMenuButton.radius / 2,
        y2: 0
        ...
        x2: 0,
        y2: 0
      }, 500, FamilyTree.anim.inOutSin)), this._linesInterval.push(FamilyTree.anim(p[2], {
        x1: -a.nodeCircleMenuButton.radius / 2,
        y1: 6,
        x2: a.nodeCircleMenuButton.radius / 2,
        y2: 6
  ...
  this._visible = !0, this.layoutBtn.style.transform = "rotate(180deg) translateX(0px) translateY(0px)", FamilyTree.anim(this.div, {
    bottom: this.obj.config.padding - 10
  }, {
    bottom: this.obj.config.padding + 135
  }, this.obj.config.anim.duration, this.obj.config.anim.func), FamilyTree.anim(this.layouts, {
    bottom: -145
  }, {
    bottom: 0
  }, this.obj.config.anim.duration, this.obj.config.anim.func)
}, FamilyTree.toolbarUI.prototype.hideLayout = function () {
  this._visible = !1, this.layoutBtn.style.transform = "rotate(0deg) translateX(0px) translateY(0px)", FamilyTree.anim(this.div, {
    bottom: this.obj.config.padding + 135
  }, {
    bottom: this.obj.config.padding - 10
  }, this.obj.config.anim.duration, this.obj.config.anim.func), FamilyTree.anim(this.layouts, {
  ...
  var n = i.offsetWidth;
  return i.style.width = "20px", FamilyTree.anim(i, {
    opacity: 0,
    width: 10
  }, {
    opacity: 1,
...
FamilyTree._lblIsImg = function (e, t) {
  ...
  var a = t.slice(0);
  t[0] < i.left && t[0] < i.right && (a[0] = i.left > i.right ? i.right : i.left), t[0] > i.right && t[0] > i.left && (a[0] = i.left > i.right ? i.left : i.right), t[1] < i.top && t[1] < i.bottom && (a[1] = i.top > i.bottom ? i.bottom : i.top), t[1] > i.bottom && t[1] > i.top && (a[1] = i.top > i.bottom ? i.top : i.bottom), t[0] !== a[0] || t[1] !== a[1] ? FamilyTree.anim(e, {
    viewBox: t
  }, {
    viewBox: a
  ...
  if (-1 != m.indexOf("multiline")) {
    ...
    T.setAttributeNS(null, "x", l), T.setAttributeNS(null, "y", s), T.setAttributeNS(null, "text-anchor", d), T.appendChild(v), h.appendChild(T);
    y = 1;
    for (var F = 1, x = 1; x < g.length; x++) {
      ...
      if (T.firstChild.data += " " + g[x], T.getComputedTextLength() > c) {
        if (T.firstChild.data = T.firstChild.data.slice(0, _), F++, a && F > a) {
          ...
          break
        }(T = document.createElementNS(p, "tspan")).setAttributeNS(null, "x", l), T.setAttributeNS(null, "y", s + b * y), T.setAttributeNS(null, "text-anchor", d), v = document.createTextNode(g[x]), T.appendChild(v), h.appendChild(T), y++
      }
    }
    var k = "";
  ...
  if (1 == r) {
    ...
    if (void 0 !== o.download) {
      ...
      o.setAttribute("href", n), o.setAttribute("download", i), o.style.visibility = "hidden", document.body.appendChild(o), o.click(), document.body.removeChild(o)
    }
  }
  ...
  e.margin && e.margin[0] < 2 && (e.margin[0] = 2), e.margin && e.margin[1] < 2 && (e.margin[1] = 2), e.margin && e.margin[2] < 2 && (e.margin[2] = 2), e.margin && e.margin[3] < 2 && (e.margin[3] = 2), this._draw(!1, FamilyTree.action.exporting, r, (function (r) {
    ...
    if ("svg" == e.ext)
      if (t) t(e, a.innerHTML);
        ...
        FamilyTree._downloadFile(e.mime, l.content, l.options.filename, l.options.openInNewTab)
      }
...
FamilyTree.prototype._exportProfile = function (e, t) {
  ...
  return {
    ...
    publish: function (t, i) {
      if (e[t]) {
        ...
        if (r.length > 0) {
          var o = !0;
          for (a = 0; a < r.length; a++) 1 == i.length ? o = r[a](i[0]) && o : 2 == i.length ? o = r[a](i[0], i[1]) && o : 3 == i.length ? o = r[a](i[0], i[1], i[2]) && o : 4 == i.length ? o = r[a](i[0], i[1], i[2], i[3]) && o : 5 == i.length && (o = r[a](i[0], i[1], i[2], i[3], i[4]) && o);
          return o
        }
      }
    }
  ...
  if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
    ...
    return F.appendChild(v), i.appendChild(F), l.onclick = function (e) {
...
FamilyTree.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (e, t, i) {
  ...
  if (n.draggable) {
    ...
    f.setAttribute("transform", "matrix(1,0,0,1," + (y + b.x) + "," + (g + b.y) + ")"), f.style.opacity = .7;
    var T = function (e, t) {
        if (null != e) {
        ...
        if (h) {
          ...
          if (s.left || s.right || s.up || s.down) {
            ...
            o.startMove(s, (function (e) {
              u[4] = v + e.x, u[5] = x + e.y, h.x = _ - e.xWithoutScale, h.y = w - e.yWithoutScale, i.x = k - e.xWithoutScale, i.y = C - e.yWithoutScale, f.setAttribute("transform", "matrix(" + u.toString() + ")")
            }))
          } else {
            for (o.stopMove(), p.classList && (p.classList.add("bft-cursor-grab"), p.classList.remove("bft-cursor-move"), p.classList.remove("bft-cursor-nodrop"), p.classList.remove("bft-cursor-copy")), T(c, m), c = null, m = null; null != r && r != p;) {
            ...
            var L = (i.x - h.x) / d,
              E = (i.y - h.y) / d;
            if (u[4] = y + L, u[5] = g + E, !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [o.nodeCircleMenuUI, {
              from: S,
              menuItem: n,
              menuItemName: a
      ...
      F = function (t) {
        if (o.stopMove(), p.classList && (p.classList.remove("bft-cursor-grab"), p.classList.remove("bft-cursor-move"), p.classList.remove("bft-cursor-nodrop"), p.classList.remove("bft-cursor-copy")), p.removeEventListener(i.move, v), p.removeEventListener(i.up, F), i.leave && p.removeEventListener(i.leave, F), s.id == c || null == c) return p.removeChild(f), o._gragStartedId = null, void(e._dragEventFired && FamilyTree.events.publish("drop", [o.nodeCircleMenuUI, {
          from: s.id,
          menuItemName: a,
          menuItem: n
        }]));
        ...
        if (c) {
          ...
          if (g.left || g.right || g.up || g.down) {
            ...
            s.startMove(g, (function (e) {
              m[4] = T + e.x, m[5] = v + e.y, c.x = F - e.xWithoutScale, c.y = x - e.yWithoutScale, i.x = _ - e.xWithoutScale, i.y = w - e.yWithoutScale, u.setAttribute("transform", "matrix(" + m.toString() + ")")
            }))
          } else {
            if (s.stopMove(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), y(o, l), o = null, l = null, s.config.enableDragDrop)
              for (; null != r && r != d;) {
                if (r.hasAttribute && r.hasAttribute(FamilyTree.attr.node_id)) {
            ...
            if (null != o) {
              ...
              for (var C = s.getNode(o), S = FamilyTree.getStParentNodes(C), I = 0; I < S.length; I++) {
                var N = s.getNodeElement(S[I].id);
                N && (N.style.opacity = .1)
              }!s._canUpdateLink(n.id, o) && d.classList ? (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-copy"), d.classList.add("bft-cursor-nodrop")) : d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.add("bft-cursor-copy"), d.classList.remove("bft-cursor-nodrop"))
            }
            var A = (i.x - c.x) / f,
              M = (i.y - c.y) / f;
            if (m[4] = p + A, m[5] = h + M, !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [s, k]) && b(), e._dragEventFired = !0;
            u.setAttribute("transform", "matrix(" + m.toString() + ")")
          }
        }
      },
      b = function (t) {
        if (s.stopMove(), d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), d.removeEventListener(i.move, g), d.removeEventListener(i.up, b), i.leave && d.removeEventListener(i.leave, b), n.id == o || null == o) return d.removeChild(u), s._gragStartedId = null, void(e._dragEventFired && FamilyTree.events.publish("drop", [s, n.id]));
        var r = s.getNode(o);
        if (!1 === FamilyTree.events.publish("drop", [s, n.id, r.id])) return y(o, l), d.removeChild(u), void(s._gragStartedId = null);
  ...
  if (e) {
    if (this._movePosition = e, !this._moveInterval) {
      ...
      this._moveInterval = setInterval((function () {
        ...
        i._movePosition.left && (n++, e.x = n * FamilyTree.MOVE_STEP / a, e.xWithoutScale = n * FamilyTree.MOVE_STEP), i._movePosition.right && (n++, e.x = -n * FamilyTree.MOVE_STEP / a, e.xWithoutScale = -n * FamilyTree.MOVE_STEP), i._movePosition.up && (o++, e.y = -o * FamilyTree.MOVE_STEP / a, e.yWithoutScale = -o * FamilyTree.MOVE_STEP), i._movePosition.down && (o++, e.y = o * FamilyTree.MOVE_STEP / a, e.yWithoutScale = o * FamilyTree.MOVE_STEP), i.setViewBox([r[0] + e.x, r[1] + e.y, r[2], r[3]]), i.xScrollUI.setPosition(), i.yScrollUI.setPosition(), t && t(e)
...
FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
  ...
  t.touches && t.touches.length > 1 && (s.type = "pinch", s.dist = Math.sqrt((o.x - l.x) * (o.x - l.x) + (o.y - l.y) * (o.y - l.y)));
  ...
  if ("pan" == s.type) {
    ...
    var c = FamilyTree._getOffsetXY(this.element, t),
      m = c.x / n + a[0] - 16 / n,
      p = c.y / n + a[1] - 16 / n;
    d.style.display = "inherit", d.setAttribute("transform", "matrix(0,0,0,0," + m + "," + p + ")"), FamilyTree.anim(d, {
...
FamilyTree.searchUI.prototype.init = function (e) {
  ...
  this.obj.element.insertBefore(i, a), FamilyTree.input.init(i), this.input = document.getElementById(r.id), this.input.addEventListener("keypress", (function (e) {
    ...
    "ArrowDown" == e.key ? (e.preventDefault(), n()) : "ArrowUp" == e.key ? (e.preventDefault(), e.stopPropagation(), o()) : "Enter" == e.key ? (e.preventDefault(), l()) : "Escape" == e.key ? (e.preventDefault(), t.hide()) : t._serverSearch(this.value)
  }));
  var n = function () {
...
FamilyTree.manager.prototype._read = function (e, t) {
  ...
  var m = n[i || "base"];
  null == e.parent && FamilyTree.manager._setCollpasedProperty(e, m, s, l, a, r - 1, c);
  for (var p = 0; p < e.childrenIds.length; p++) {
    var h = t[e.childrenIds[p]];
    if (FamilyTree.manager._setCollpasedProperty(h, m, s, l, a, r, c), !h.collapsed) {
      if (h.parent = e, null != h.ppid) {
        var f = t[h.ppid];
        f && (h.parentPartner = f)
      }(-1 != h.tags.indexOf("left-partner") || -1 != h.tags.indexOf("right-partner") || -1 != h.tags.indexOf("partner") || h.parentPartner) && -1 == d.indexOf(e.id) && d.push(e.id), e.children.push(h)
    }
  }
  if (e.min || a != FamilyTree.action.minimize || (s.all || s.id == e.id) && (e.min = !0), !0 === e.min && a == FamilyTree.action.maximize && (s.all || s.id == e.id) && (e.min = !1), a == FamilyTree.action.init && null != c && (e.min = c.min.has(e.id)), !e.min)
  ...
  e.w = u && u.size ? u.size[0] : 0, e.h = u && u.size ? u.size[1] : 0, e.padding = u && u.padding ? u.padding : [0, 0, 0, 0], null != r && (e.level = r), i && (e.lcn = i);
  var y = FamilyTree._getSubLevels(e.tags, o.tags);
  y > 0 && (e.subLevels = y), -1 != e.tags.indexOf("assistant") && null != e.parent && (e.isAssistant = !0), FamilyTree.events.publish("node-created", [e])
}, FamilyTree.manager._iterate = function (e, t, i, r, a, n, o, l, s, d, c, m, p, h, f, u) {
  if (FamilyTree.manager._initNode(t, i, s, r, m, d, c, p, h, f, u), t.isAssistant && (n[t.pid] || (n[t.pid] = []), n[t.pid].push(t.id)), t.subLevels > 0 && o.push(t.id), FamilyTree.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !t.isAssistant && t.parent) {
    if (t.parent && t.parent.children.length && t.parent.children[t.parent.children.length - 1] == t) {
      for (var y = [], g = 0, b = 0, T = 0; T < t.parent.children.length; T++) {
        -1 == (v = t.parent.children[T]).tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") && -1 == v.tags.indexOf("assistant") && 0 == v.children.length ? y.push(v.id) : -1 != v.tags.indexOf("assistant") ? g++ : -1 == v.tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") || b++
      }(FamilyTree.MIXED_LAYOUT_ALL_NODES && y.length > 1 && y.length == t.parent.children.length - g - b || !FamilyTree.MIXED_LAYOUT_ALL_NODES && y.length > 1) && (l[t.pid] = y)
    }
  } else if (!t.isAssistant && 0 == t.childrenIds.length && t.parent && !l[t.pid]) {
    for (y = [], g = 0, b = 0, T = 0; T < t.parent.children.length; T++) {
      var v; - 1 == (v = t.parent.children[T]).tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") && -1 == v.tags.indexOf("assistant") && 0 == v.childrenIds.length ? y.push(v.id) : -1 != v.tags.indexOf("assistant") ? g++ : -1 == v.tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") || b++
    }(FamilyTree.MIXED_LAYOUT_ALL_NODES && y.length > 1 && y.length == t.parent.childrenIds.length - g - b || !FamilyTree.MIXED_LAYOUT_ALL_NODES && y.length > 1) && (l[t.pid] = y)
  }
  ...
  for (var F = 0; F < t.stChildren.length; F++) {
    ...
    a.push(t.stChildren[F].id), FamilyTree.manager._iterate(e, t.stChildren[F], i, 0, a, n, o, l, x, d, c, m, p, h, f, u)
  }
  r++;
  for (F = 0; F < t.children.length; F++) FamilyTree.manager._iterate(e, t.children[F], i, r, a, n, o, l, s, d, c, m, p, h, f, u)
}, FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o) {
  for (var l = i.nodes, s = [], d = 0; d < l.length; d++) {
    var c, m = l[d];
    c = FamilyTree.STRING_TAGS ? m.tags ? m.tags.split(",") : [] : Array.isArray(m.tags) ? m.tags.slice(0) : [];
    var p = FamilyTree._getTemplate(c, i.tags, i.template),
      h = new FamilyTree.node(m.id, m.pid, c, p);
    FamilyTree.isNEU(m.ppid) || (h.ppid = m.ppid), FamilyTree.isNEU(m.stpid) || (h.stpid = m.stpid), null != i.orderBy && (h.order = FamilyTree.manager._getOrderFieldValue(m, i.orderBy)), e[m.id] = h, s.push(m.id)
  }
  ...
  for (d = 0; d < s.length; d++) {
    ...
    } else g ? (u && (h.collapsed = u.collapsed, h.min = u.min), g.childrenIds.push(h.id)) : (u && (h.collapsed = u.collapsed, h.min = u.min), t.push(h), o.push(h.id));
  ...
  var o = {},
    l = [],
    s = [];
  if (FamilyTree.manager.__createNodes(o, l, e, i, r, a, s), null != e.roots) {
    l = [];
    for (var d = 0; d < e.roots.length; d++) {
      var c = o[e.roots[d]];
      if (c && i == FamilyTree.action.centerNode) {
        for (var m = c; null != m.pid || null != m.stpid;) m = null == m.pid && null != m.stpid ? o[m.stpid] : o[m.pid];
        for (var p = o[r.id]; null != p.pid || null != p.stpid;) p = null == p.pid && null != p.stpid ? o[p.stpid] : o[p.pid];
        m == p && (c = m)
      }
      if (c) {
        ...
        if (!h) {
          if (!FamilyTree.isNEU(c.pid))(P = (b = o[c.pid]).childrenIds.indexOf(c.id)) > -1 && b.childrenIds.splice(P, 1);
          l.push(c)
        }
      }
    }
  ...
  i == FamilyTree.action.exporting && null != r.id && ((y = o[r.id]) && (y.pid = null, l = [y]));
  var u = [];
  if (i == FamilyTree.action.init && e.expand && e.expand.nodes && null == n)
    for (d = 0; d < e.expand.nodes.length; d++) {
      var y = o[e.expand.nodes[d]];
      for (!0 === e.expand.allChildren && FamilyTree.manager._addExpandedNodeIdsIterate(y, o, u); y;) u.push(y.id), null == y.pid && null != y.stpid ? (y = o[y.stpid]).min = !1 : y = o[y.pid]
    } else if (i == FamilyTree.action.expand && r.ids && "all" != r.ids || i == FamilyTree.action.collapse && r && r.expandIds) {
      var g;
      g = i == FamilyTree.action.expand ? r.ids : r.expandIds;
      for (d = 0; d < g.length; d++)
        for (var b = o[(y = o[g[d]]).pid]; b;) u.push(b.id), null == b.pid && null != b.stpid ? (b = o[b.stpid]).min = !1 : b = o[b.pid]
    } else if (i == FamilyTree.action.centerNode) {
    for (var T = o[r.id]; T;) {
      if (u.push(T.id), r.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && T)
        for (d = 0; d < T.childrenIds.length; d++) {
          (U = o[T.childrenIds[d]]).collapsed = !0
        }
      null == T.pid && null != T.stpid ? (T = o[T.stpid]).min = !1 : T = o[T.pid]
    }
    T = o[r.id];
    ...
    if (r.options.parentState === FamilyTree.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED)
      if (b = o[T.pid])
    ...
    for (y = o[r.insertedNodeId]; y;) u.push(y.id), null == y.pid && null != y.stpid ? (y = o[y.stpid]).min = !1 : y = o[y.pid];
  var x = [],
    _ = {},
    w = [],
    k = {},
    C = [];
  for (d = 0; d < l.length; d++) FamilyTree.manager._iterate(l[d], l[d], o, 0, x, _, w, k, "", t, e, i, u, r, C, n);
  ...
  for (d = 0; d < C.length; d++) {
    ...
    for (v = 0; v < y.children.length; v++) {
      (U = y.children[v]).isAssistant ? S.push(U.id) : -1 != U.tags.indexOf("right-partner") ? (U.isPartner = 1, U.children = [], I.push(U.id)) : -1 != U.tags.indexOf("left-partner") ? (U.isPartner = 2, U.children = [], N.push(U.id)) : -1 == U.tags.indexOf("partner") || M % 2 ? -1 != U.tags.indexOf("partner") && M % 2 ? (U.isPartner = 2, U.children = [], N.push(U.id), M++) : U.parentPartner ? (A[U.parentPartner.id] || (A[U.parentPartner.id] = []), A[U.parentPartner.id].push(U.id)) : S.push(U.id) : (U.isPartner = 1, U.children = [], I.push(U.id), M++)
    }
    y.children = [];
    ...
    for (v = N.length - 1; v >= 0; v--)
      if (A[N[v]])
        for (f = 0; f < A[N[v]].length; f++) y.children.push(o[A[N[v]][f]]), L++, -1 == O.indexOf(N[v]) && O.push(N[v]);
    ...
    for (v = 0; v < I.length; v++)
      if (A[I[v]])
        for (f = 0; f < A[I[v]].length; f++) y.children.push(o[A[I[v]][f]]), E++, -1 == B.indexOf(I[v]) && B.push(I[v]);
    y.partnerSeparation = Math.max(O.length, B.length) * e.partnerChildrenSplitSeparation + e.minPartnerSeparation, S.length || !L || E ? S.length || L || !E ? S.length || 1 != L || 1 != E ? S.length || L || E ? !S.length || L || E ? S.length && (L || E) ? y.hasPartners = 7 : y.hasPartners = 1 : y.hasPartners = 6 : y.hasPartners = 5 : y.hasPartners = 4 : y.hasPartners = 3 : y.hasPartners = 2
  }
  for (d = 0; d < w.length; d++) {
    if ((Z = t[(y = o[w[d]]).lcn ? y.lcn : "base"]).layout == FamilyTree.normal || !k[y.pid])
      for (v = 0; v < y.subLevels; v++) {
        var P, z = new FamilyTree.node(y.id + "_sub_level_index_" + v, y.pid, [], "subLevel");
        if (FamilyTree.manager._initDinamicNode(z, y.lcn), b = y.parent)(P = b.children.indexOf(y)) > -1 && (b.children.splice(P, 1), b.children.splice(P, 0, z)), z.children.push(y), z.parent = b, y.parent = z, o[z.id] = z
      }
  }
  for (var D in _) {
    (b = o[D]).hasAssistants = !0;
    z = new FamilyTree.node(b.id + "_split_assitant_0", b.id, ["assistant"], "split");
    FamilyTree.manager._initDinamicNode(z, b.lcn, !0), o[z.id] = z;
    var j = [];
    for (v = b.children.length - 1; v >= 0; v--) {
      (U = b.children[v]).isAssistant ? (U.parent = null, b.children.splice(v, 1), j.splice(0, 0, U.id)) : U.isPartner || (U.parent && k[U.parent.id] && z && U.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, U.parent.id)), delete k[U.parent.id]), U.parent = z, z.children.unshift(U), b.children.splice(v, 1))
    }
    if (j.length % 2) {
      var H = o[j[j.length - 1]],
        R = new FamilyTree.node(H.id + "_mirror", H.pid, [], "mirror");
      FamilyTree.manager._initDinamicNode(R, H.lcn, !0), H._m = R.id, R.isAssistant = !0, R.w = H.w, R.h = H.h, o[R.id] = R, j.splice(j.length - 1, 0, R.id)
    }
    var $ = 1;
    for (v = j.length - 1; v >= 0; v--)
      if (v % 2 && v != j.length - 1) {
        var q = new FamilyTree.node(b.id + "_split_assitant_" + $, null, [], "split");
        FamilyTree.manager._initDinamicNode(q, b.lcn, !0), o[q.id] = q, j.splice(v, 0, q.id), $++
    ...
    for (v = 0; v < j.length; v += 3) {
      ...
      var Y = o[j[v]],
        V = o[j[v + 1]],
        W = o[j[v + 2]];
      Y.parent = X, V.parent = X, W.parent = X, X.children.push(Y), X.children.push(V), X.children.push(W)
    }
  }
  var G = !1;
  for (var K in t) {
    if ((Z = t[K]).layout == FamilyTree.mixed || Z.layout == FamilyTree.tree || Z.layout == FamilyTree.treeRightOffset || Z.layout == FamilyTree.treeLeftOffset) {
      G = !0;
      break
    }
  }
  if (G) {
    ...
    for (var D in k) {
      var Z;
      if ((Z = t[(b = o[D]).lcn ? b.lcn : "base"]).layout == FamilyTree.mixed || Z.layout == FamilyTree.tree || Z.layout == FamilyTree.treeRightOffset || Z.layout == FamilyTree.treeLeftOffset)
        if (J.pnode = b, J.layout = Z.layout, J.childrenIds = k[D], J.lastChildrenPidIds = k, FamilyTree.events.publish("layout", [J]), J.layout == FamilyTree.mixed) {
          var Q = J.childrenIds;
          for (d = Q.length - 1; d >= 0; d--) {
            ...
            if (d > 0) {
              var ee = o[Q[d - 1]];
              U.parent = ee, U.layout = FamilyTree.mixed, ee.children.push(U)
            } else b.children.push(U)
          }
        } else if (J.layout == FamilyTree.tree || J.layout == FamilyTree.treeRightOffset || J.layout == FamilyTree.treeLeftOffset) {
        z = new FamilyTree.node(b.id + "_split_0", b.id, [], "split");
        FamilyTree.manager._initDinamicNode(z, b.lcn), o[z.id] = z, z.layout = FamilyTree.tree;
        var te = [];
        for (d = J.childrenIds.length - 1; d >= 0; d--) {
          for (U = o[J.childrenIds[d]], v = 0; v < b.children.length; v++) b.children[v].id == U.id && b.children.splice(v, 1);
          if (U.parent = null, U.layout = FamilyTree.tree, J.layout == FamilyTree.treeRightOffset && te.splice(0, 0, U.id), J.layout == FamilyTree.treeLeftOffset || J.layout == FamilyTree.treeRightOffset) {
            var ie = new FamilyTree.node(U.id + "_mirror", null, [], "mirror");
            FamilyTree.manager._initDinamicNode(ie, U.lcn), ie.layout = FamilyTree.tree, o[ie.id] = ie, te.splice(0, 0, ie.id)
          }
          J.layout != FamilyTree.treeRightOffset && te.splice(0, 0, U.id)
        }
        for ($ = 1, v = te.length - 1; v >= 0; v--)
          if (v % 2 && v != te.length - 1) {
            q = new FamilyTree.node(b.id + "_split_" + $, null, [], "split");
            FamilyTree.manager._initDinamicNode(q, b.lcn), q.layout = FamilyTree.tree, o[q.id] = q, te.splice(v, 0, q.id), $++
          } else v % 2 && te.splice(v, 0, z.id);
        for (v = 0; v < te.length; v += 3) {
          X = null;
          0 == v && (X = b);
          Y = o[te[v]], V = o[te[v + 1]], W = o[te[v + 2]];
          0 != v && (X = o[te[v - 3]]), 0 == v || V || (X = o[te[v - 2]]), Y.parent = X, X.children.push(Y), V && (0 != v && (X = o[te[v - 2]]), V.parent = X, X.children.push(V)), W && (0 != v && (X = o[te[v - 1]]), W.parent = X, X.children.push(W))
        }
      }
    }
  }
  ...
  if (c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
    var C = p[m.id];
    1 == m.options.horizontal && (s[0] = C.x + C.w / 2 - s[2] / 2), 1 == m.options.vertical && (s[1] = C.y + C.h / 2 - s[3] / 2), r.sticky && (s[0] < g.left && s[0] < g.right && (s[0] = g.left > g.right ? g.right : g.left), s[0] > g.right && s[0] > g.left && (s[0] = g.left > g.right ? g.left : g.right), s[1] < g.top && s[1] < g.bottom && (s[1] = g.top > g.bottom ? g.bottom : g.top), s[1] > g.bottom && s[1] > g.top && (s[1] = g.top > g.bottom ? g.top : g.bottom))
  }
  if (c == FamilyTree.action.insert || c == FamilyTree.action.expand || c == FamilyTree.action.collapse || c == FamilyTree.action.update || c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
    var S = null;
    if (c == FamilyTree.action.insert && m && null != m.insertedNodeId && null != m.insertedNodeId) S = p[m.insertedNodeId];
    else if (c == FamilyTree.action.update && m && null != m.visId && null != m.visId) S = p[m.visId];
    ...
    if (!FamilyTree.FIXED_POSITION_ON_CLICK && S) switch (r.orientation) {
    case FamilyTree.orientation.top:
    case FamilyTree.orientation.top_left:
...
FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o) {
  ...
  for (p = 0; p < d.length; p++) {
    ...
    if (g) {
      var b = [];
      FamilyTree.manager._iterateSetRootIds(g.id, g.id, m, c, e, b), o.push(b)
    }
  }
...
FamilyTree.manager._iterateSetRootIds = function (e, t, i, r, a, n) {
  ...
  for (var y = 0; y < c.pids.length; y++) {
    ...
    if (g) {
      g.pid = c.id;
      var b = a ? a[g.id] : null;
      b && (g.collapsed = b.collapsed, g.min = b.min), o == FamilyTree.action.init && (g.min = FamilyTree._getMin(g, s)), l && m && b && l.id == c.id ? b.hasPartners && 1 == m.isPartner ? g.tags.push("left-partner") : b.hasPartners && 2 == m.isPartner || 1 == m.isPartner ? g.tags.push("right-partner") : 2 == m.isPartner ? g.tags.push("left-partner") : g.tags.push("partner") : b && 2 == b.isPartner ? g.tags.push("left-partner") : b && 1 == b.isPartner ? g.tags.push("right-partner") : g.tags.push("partner"), c.childrenIds.push(g.id), g.ftChildrenIds = c.ftChildrenIds
    }
  }
  if (t[e])
    for (var T = 0; T < t[e].length; T++) FamilyTree.manager._iterateFT(t[e][T], t, i, r, a, n, o, l, s);
  if (i[e])
  ...
  node: function (e, t, i, r, a, n, o, l, s, d) {
    ...
    for (var h in o) {
      ...
      if (t && (f = t[u]), "function" == typeof u && (f = u(d, e, t)), p.value = f, p.element = c[h], p.name = u, !1 !== FamilyTree.events.publish("field", [d, p]))
        if (null != p.value && null != p.value && null != p.element) FamilyTree._lblIsImg(r, h) || "string" != typeof p.value || (p.value = FamilyTree.wrapText(p.value, p.element)), m += p.element.replace("{val}", (function () {
          return p.value
        })).replaceAll("{ew}", e.w - (e.padding ? e.padding[1] : 0)).replaceAll("{cw}", e.w / 2).replaceAll("{randId}", FamilyTree.randomId()).replaceAll("{randId2}", FamilyTree.randomId())
    }
    ...
    return m = (T = T.replace("{opacity}", v)) + (m += FamilyTree.ui.nodeBtns(r, e, l, c, d)) + FamilyTree.grCloseTag
  },
  ...
  link: function (e, t, i, r, a, n) {
    ...
    e.layout != FamilyTree.mixed && e.layout != FamilyTree.tree || (c = l.mixedHierarchyNodesSeparation / 2);
    var m = 0,
    ...
    for (u = 0; u < e.children.length; u++) {
      ...
      if (f && -1 != f.ids.indexOf(y.id)) switch (l.orientation) {
      case FamilyTree.orientation.top:
      case FamilyTree.orientation.top_left:
      ...
      } else if ((y.isAssistant || 2 == y.layout) && y.rightNeighbor && y.rightNeighbor.isSplit) switch (l.orientation) {
      case FamilyTree.orientation.top:
      case FamilyTree.orientation.top_left:
      case FamilyTree.orientation.bottom:
      case FamilyTree.orientation.bottom_left:
      ...
      } else if ((y.isAssistant || 2 == y.layout) && y.leftNeighbor && y.leftNeighbor.isSplit) switch (l.orientation) {
      case FamilyTree.orientation.top:
      case FamilyTree.orientation.top_left:
      case FamilyTree.orientation.bottom:
      case FamilyTree.orientation.bottom_left:
      ...
      for (var k in t.config.linkBinding) {
        ...
        if (S) {
          var I = S[C];
          _.value = I, _.element = s[k], _.name = C, !1 !== FamilyTree.events.publish("label", [t, _]) && (FamilyTree.isNEU(_.value) || FamilyTree.isNEU(_.element) || (w += _.element.replace("{val}", _.value)))
        }
      }
  ...
  _roundedEdge: function (e, t, i, r, a, n) {
    ...
    var l, s, d, c = 0;
    return e == i && e == a || t == r && t == n ? (l = d = i, s = c = r) : (e != a && i == a && (l = d = i, s = r, t < n ? c = r + o : t > n && (c = r - o)), e < a && i == a ? i -= o : e > a && i == a && (i += o), t != n && r == n && (l = i, s = c = r, e < a ? d = i + o : e > a && (d = i - o)), t < n && r == n ? r -= o : t > n && r == n && (r += o)), {
      x1: e,
      y1: t,
      x2: i,
      y2: r,
  ...
  _linkTopToBottom: function (e, t, i, r, a) {
    ...
    return n = e.x + e.w / 2 + i.linkAdjuster.toX, o = e.y + e.h + i.linkAdjuster.toY, s = l = t.x + t.w / 2 + i.linkAdjuster.fromX, d = t.y + i.linkAdjuster.fromY, {
      ...
      ya: o,
      xb: n,
      yb: c = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.y + e.rightNeighbor.h + r : "split" != e.templateName || !t.isAssistant && 2 != t.layout ? "split" == t.templateName ? o + r : null != a ? a : d - r : d,
      xc: l,
      yc: c,
      xd: s,
      yd: d,
  ...
  _linkBottomToTop: function (e, t, i, r, a) {
    ...
    return n = e.x + e.w / 2 + i.linkAdjuster.toX, o = e.y + i.linkAdjuster.toY, s = l = t.x + t.w / 2 + i.linkAdjuster.fromX, d = t.y + t.h + i.linkAdjuster.fromY, {
      ...
      ya: o,
      xb: n,
      yb: c = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.y - r : "split" != e.templateName || !t.isAssistant && 2 != t.layout ? "split" == t.templateName ? o - r : null != a ? a : d + r : d,
      xc: l,
      yc: c,
      xd: s,
      yd: d,
  ...
  if ((this.config.mouseScrool == FamilyTree.action.xScroll || this.config.mouseScrool == FamilyTree.action.scroll) && this.bar) {
    ...
    ! function (e, i, r) {
      ...
      function n() {
        ...
        Math.ceil(t.bar.scrollLeft) == Math.ceil(t.pos) ? a = !1 : (t.bar.scrollLeft += e, o(n))
      }
      e.addEventListener("wheel", (function (e) {
        ...
        var o = parseFloat(t.innerBar.clientWidth) - parseFloat(t.bar.clientWidth);
        t.pos < 0 && (t.pos = 0);
        t.pos > o && (t.pos = o);
        a || n()
      }), {
      ...
      var o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (e) {
        setTimeout(e, 20)
      }
    }(e, i.speed, i.smooth)
  }
  ...
  if (this.config.mouseScrool == FamilyTree.action.yScroll || this.config.mouseScrool == FamilyTree.action.scroll) {
    ...
    ! function (e, i, r) {
      ...
      function n() {
        ...
        Math.ceil(t.bar.scrollTop) == Math.ceil(t.pos) ? a = !1 : (t.bar.scrollTop += e, o(n))
      }
      e.addEventListener("wheel", (function (e) {
        var r = 0;
        ...
        r = -r, r = Math.max(-1, Math.min(1, r)), t.pos += -r * i;
        var o = parseFloat(t.innerBar.clientHeight) - parseFloat(t.bar.clientHeight);
        t.pos < 0 && (t.pos = 0);
        t.pos > o && (t.pos = o);
        a || n()
      }), {
...
FamilyTree.prototype.zoom = function (e, t, i, r) {
  ...
  if (a[2] = this.width() / s, a[3] = this.height() / s, !0 === e && s < this.config.scaleMax || !1 === e && s > this.config.scaleMin || 0 != e && 1 != e && s < this.config.scaleMax && s > this.config.scaleMin) {
    this._hideBeforeAnimation();
    var d = this;
    i ? (clearTimeout(d._timeout), FamilyTree.anim(this.getSvg(), {
  ...
  l.value = t.format, s.value = t.landscape, d.value = t.scale, c.value = t.margin, m.value = t.header, p.value = t.footer, FamilyTree.anim(e.element.querySelector("#bft-ppdf-btns"), {
    margin: [0, 0, 0, -250]
  }, {
    margin: [0, 0, 0, 0]
  }, 300, FamilyTree.anim.outSin, (function () {
    ...
    FamilyTree.anim(e.element.querySelector("#bft-ppdf-content"), {
      opacity: 1
    }, {
      opacity: 0
  ...
  for (var i, r, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
    ...
    if (c && -1 != t.res.visibleNodeIds.indexOf(c.id) && (m && -1 != t.res.visibleNodeIds.indexOf(m.id))) {
      ...
      case FamilyTree.orientation.top:
      case FamilyTree.orientation.top_left:
        b <= T ? (x = 1, y.x = b + c.w / 10, g.x = T - m.w / 10) : (x = -1, y.x = b - c.w / 10, g.x = T + m.w / 10), h == u ? (x = 1, y.y = h, g.y = u) : h > u ? (y.y = h, g.y = u + m.h) : (y.y = h + c.h, g.y = u);
        break;
      case FamilyTree.orientation.bottom:
      case FamilyTree.orientation.bottom_left:
        b <= T ? (x = -1, y.x = b + c.w / 10, g.x = T + m.w / 10) : (x = 1, y.x = b - c.w / 10, g.x = T + m.w / 10), h == u ? (x = -1, y.y = h + c.h, g.y = u + m.h) : h > u ? (y.y = h, g.y = u + m.h) : (y.y = h + c.h, g.y = u);
        break;
      case FamilyTree.orientation.left:
      case FamilyTree.orientation.left_top:
      ...
      var k = FamilyTree.clinkTemplates[w],
        C = (i = y, a = _, n = void 0, o = void 0, n = ((r = g).x - i.x) / 2 + i.x, o = (r.y - i.y) / 2 + i.y, {
          x: (n - a.x) / 2 + a.x,
          y: (o - a.y) / 2 + a.y
        });
      d.label && (l += k.label.replace("{x}", C.x).replace("{y}", C.y).replace("{val}", d.label));
      var S = "M" + y.x + "," + y.y + "C" + y.x + "," + y.y + " " + _.x + "," + _.y + " " + g.x + "," + g.y;
      l += ("<g " + FamilyTree.attr.c_link_from + '="{from}" ' + FamilyTree.attr.c_link_to + '="{to}">').replace("{from}", c.id).replace("{to}", m.id) + k.link.replaceAll("{d}", S) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + S + '" />', l += FamilyTree.grCloseTag
    }
...
FamilyTree.prototype.removeClink = function (e, t) {
  ...
  function n(t, n, o) {
    ...
    if (t.level == n.level) switch (d = n, p.orientation) {
    case FamilyTree.orientation.top:
    case FamilyTree.orientation.top_left:
    ...
    case FamilyTree.orientation.right_top:
      ...
      for (var y = t; null == d;) {
        var g = !1,
          ...
          T = b.leftNeighbor,
          v = b.rightNeighbor;
        if (b.id == n.id ? d = b : FamilyTree._intersects(b, u, e.config) && (u = FamilyTree._addPoint(b, s, e.config, u, c), g = !0), b.id != n.id) {
          for (; T;) {
            if (T.id == n.id) {
              d = T;
              break
            }
            FamilyTree._intersects(T, u, e.config) && (u = FamilyTree._addPoint(T, s, e.config, u, c), g = !0), T = T.leftNeighbor
          }
          for (; v;) {
            if (v.id == n.id) {
              d = v;
        ...
        if (!g) {
          var F = s[s.length - 1][0],
            x = 0;
          if (b.parent) switch (f = p.levelSeparation, b.parent.layout != FamilyTree.mixed && b.parent.layout != FamilyTree.tree || (f = p.mixedHierarchyNodesSeparation), p.orientation) {
          case FamilyTree.orientation.top:
          case FamilyTree.orientation.top_left:
          ...
          case FamilyTree.orientation.left:
          case FamilyTree.orientation.left_top:
            F = b.parent.x + b.parent.w + f * (2 / 3), x = s[s.length - 1][1];
            break;
          case FamilyTree.orientation.right:
          case FamilyTree.orientation.right_top:
    ...
    var N = s.join(" ");
    if (l.label) {
      var A = h.label.replace("{x}", C.x).replace("{y}", C.y).replace("{val}", l.label),
      ...
      i += h.label.replace("{x}", C.x).replace("{y}", C.y + L).replace("{val}", l.label)
    }
    i += ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", t.id).replace("{to}", n.id) + h.link.replaceAll("{d}", N) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + N + '" />', i += FamilyTree.grCloseTag
  }
...
FamilyTree.prototype.removeSlink = function (e, t) {
  ...
  if (e.config.miniMap) {
    ...
    var a = e.response.boundary.maxX - e.response.boundary.minX,
      ...
      l = (i.width - a * o) / 2,
      s = (i.height - n * o) / 2;
    r.clearRect(0, 0, i.width, i.height), r.translate(-e.response.boundary.minX * o + l, -e.response.boundary.minY * o + s), r.scale(o, o);
    var d = 0,
      c = [];
    ! function e(t, i) {
      if (Array.isArray(i))
        for (var a = 0; a < i.length; a++) e(t, i[a]);
      else {
        ...
        for (a = 0; a < i.stChildrenIds.length; a++) d++, c.includes(i.id) || (1 == d ? r.fillStyle = FamilyTree.miniMap.colors[0] : 2 == d ? r.fillStyle = FamilyTree.miniMap.colors[1] : 3 == d && (r.fillStyle = FamilyTree.miniMap.colors[2]), r.beginPath(), r.fillRect(i.x, i.y, i.w, i.h), r.strokeRect(i.x, i.y, i.w, i.h), c.push(i.id)), e(t, t.getNode(i.stChildrenIds[a])), d--;
    ...
    var m = e.getViewBox()[0],
      ...
      h = e.getViewBox()[2],
      f = e.getViewBox()[3];
    r.lineWidth = .5 / o, r.strokeStyle = "#f57c00", r.strokeRect(m, p, h, f), r.globalAlpha = .4, r.fillStyle = FamilyTree.miniMap.selectorBackgroundColor, r.fillRect(m, p, h, f)
  }
})), FamilyTree.miniMap = {}, FamilyTree.miniMap._getCanvas = function (e) {
  if (!(t = e.element.querySelector("[" + FamilyTree.attr.id + '="mini-map"]'))) {
    ...
    var i = document.createElement("div");
    i.classList.add("mini-map"), i.style.position = "absolute", i.style.bottom = "10px", i.style.left = "10px", i.style.border = "1px solid #aeaeae", i.style.padding = "5px", i.style.margin = e.config.padding + "px", i.style.backgroundColor = FamilyTree.miniMap.backgroundColor, i.appendChild(t), e.element.appendChild(i)
  }
  return t
}, FamilyTree.miniMap.colors = ["#E0E0E0", "#BDBDBD", "#9E9E9E", "#757575"], FamilyTree.miniMap.selectorBackgroundColor = "white", FamilyTree.miniMap.backgroundColor = "white", FamilyTree._search = {}, FamilyTree._search.search = function (e, t, i, r, a, n) {
  var o = [],
  ...
  for (var s = {}, d = 0; d < e.length; d++)
    for (var c = e[d], m = 0; m < i.length; m++) {
      ...
      if (!FamilyTree.isNEU(c[p])) {
        var h = c[p];
        if (null != (t = FamilyTree._search.searchAndComputeScore(l, h, p, n))) {
          var f = c.id;
          if (s[f]) {
            if (s[f] && s[f] < t.__score) {
              s[f] = t.__score;
              for (var u = o.length - 1; u >= 0; u--) o[u].id == f && o.splice(u, 1);
              FamilyTree._search.addNodeToResult(o, r, c, t, p, a)
            }
          } else s[f] = t.__score, FamilyTree._search.addNodeToResult(o, r, c, t, p, a)
        }
      }
    }
  ...
  if (n.length) {
    ...
    for (var c = 0; c < n.length; c++)
      if (l += n[c].length, n[c].start < s && (s = n[c].start), c >= 1 && n[c - 1].start > n[c].start) {
        d = 0;
        break
      }
  }
  ...
  f > 100 && (f = 100), n.sort((function (e, t) {
  ...
  if (e.config.state) {
    ...
    }(e.roots), FamilyTree.state._put(e.width(), e.height(), e.response.viewBox, i, r, e.response.adjustify, e.config.state)
  }
  ...
  if (o) {
    ...
    if (o.writeToUrlParams) {
      ...
      d.has(l.paramScale) ? d.set(l.paramScale, s.scale) : d.append(l.paramScale, s.scale), d.has(l.paramX) ? d.set(l.paramX, s.x) : d.append(l.paramX, s.x), d.has(l.paramY) ? d.set(l.paramY, s.y) : d.append(l.paramY, s.y), d.has(l.paramExp) ? d.set(l.paramExp, s.exp.join("*")) : d.append(l.paramExp, s.exp.join("*")), d.has(l.paramMin) ? d.set(l.paramMin, s.min.join("*")) : d.append(l.paramMin, s.min.join("*")), d.has(l.paramAdjustify) ? d.set(l.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y) : d.append(l.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y), window.history.replaceState(null, null, "?" + d)
    }
    o.writeToIndexedDB && (s.id = o.name, FamilyTree.idb.put(s, (function (e) {
      0 == e && console.error("Cannot write row - " + o.name)
    }))), o.writeToLocalStorage && FamilyTree.localStorage.setItem(o.name, JSON.stringify(s))
  }
  ...
  if (e) {
    ...
    if (e.readFromUrlParams) {
      ...
      if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
        ...
        (m = [])[0] = s, m[1] = d, m[2] = t / l, m[3] = i / l, o.vb = m, o.scale = l, o.x = s, o.y = d, o.exp = n.get(a.paramExp).split("*"), o.min = n.get(a.paramMin).split("*");
...
FamilyTree.prototype.magnify = function (e, t, i, r, a) {
  ...
  if (n || o) {
    ...
    if (l && (null != l.timer && clearInterval(l.timer), null != l.timerBack && clearInterval(l.timerBack), o.setAttribute("transform", "matrix(" + l.transformStart.toString() + ")"), FamilyTree._magnify[e]), i) o = o.cloneNode(!0), this.getSvg().appendChild(o);
...
FamilyTree.prototype.magnifyBack = function (e, t, i) {
  ...
  if (r) {
    ...
    r.timerBack = FamilyTree.anim(r.nodeElement, {
      transform: a
    }, {
  ...
  e.config.enableKeyNavigation && (e._addEvent(window, "keydown", e._windowKeyDownHandler), FamilyTree.isNEU(e._keyNavigationActiveNodeId) && e.roots && e.roots.length && (e._keyNavigationActiveNodeId = e.roots[0].id, e.center(e._keyNavigationActiveNodeId)))
...
FamilyTree.prototype.showTreeMenu = function (e) {
  ...
  if (this._tree_menu_temp = {
    ...
    }, this.config.nodes = [], n) this.add(n);
  else {
    var m = {
      id: "_ft_mother",
      templateName: "mother",
    ...
    c.mid = m.id, a ? (a.pids = [m.id], m.pids = [a.id], m._ft_data.pids = [a.id]) : m.pids = ["_ft_father"], this.add(m)
  }
  if (a) this.add(a);
  else {
    var p = {
    ...
    c.fid = p.id, n ? (n.pids = [p.id], p.pids = [n.id], p._ft_data.pids = [n.id]) : p.pids = ["_ft_mother"], this.add(p)
  }
  ...
  if ("male" == c.gender ? (h.templateName = "wife", h._ft_data.gender = "female") : "female" == c.gender && (h.templateName = "husband", h._ft_data.gender = "male"), c.pids.push(h.id), this.add(h), c.pids)
    for (s = 0; s < c.pids.length; s++) {
      if (this.add({
        ...
        "male" == c.gender && "female" == h._ft_data.gender ? (f._ft_childData.mid = h.id, f._ft_childData.fid = c.id, f._ft_parentData.gender = h._ft_data.gender, u._ft_childData.mid = h.id, u._ft_childData.fid = c.id, u._ft_parentData.gender = h._ft_data.gender) : "female" == c.gender && "male" == h._ft_data.gender && (f._ft_childData.mid = c.id, f._ft_childData.fid = h.id, f._ft_parentData.gender = h._ft_data.gender, u._ft_childData.mid = c.id, u._ft_childData.fid = h.id, u._ft_parentData.gender = h._ft_data.gender), this.add(f), this.add(u)
      } else this.add({
        id: "_ft_son_" + s,
        stpid: "_ft_child_group_" + s,
        templateName: "son",
      ...
      for (var y = 0; y < l.length; y++) l[y].mid != c.pids[s] && l[y].fid != c.pids[s] || (l[y].mid = void 0, l[y].fid = void 0, l[y].stpid = "_ft_child_group_" + s, this.add(l[y]))
    }
  this.add(c);
  var g = this;
  ...
  this._draw(!1, FamilyTree.action.update, b, (function () {
    FamilyTree._moveToBoundaryArea(g.getSvg(), g.getViewBox(), g.response.boundary)
  }))
  ...
  if (e instanceof FamilyTree) {
    ...
    if (i._ft_method) return "addParentNode" == i._ft_method ? e[i._ft_method](i._ft_childId, i._ft_type, i._ft_data, null, !0) : "addChildAndPartnerNodes" == i._ft_method ? e[i._ft_method](i._ft_id, i._ft_childData, i._ft_parentData, null, !0) : e[i._ft_method](i._ft_data, null, !0), !1;
...
FamilyTree.prototype.onNodeDoubleClick = function (e) {
  ...
  if (FamilyTree.LIMIT_NODES || (s.l = !0), null != FamilyTree.remote._fromReqDTO) FamilyTree.remote._fromReqDTO(s.n, s.r, s.c, (function (t) {
    ...
    d ? FamilyTree.remote._proceed(e, JSON.parse(d), r, i) : FamilyTree.remote._findRegion((function (t) {
